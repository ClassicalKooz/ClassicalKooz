...
ts = msprime.sim_ancestry(sequence_length=100, samples={"pop1": 10, "pop2": 10, "Ghost":10}, demography=demography, random_seed=8036)
...
with open("model2_replicate4.vcf","w") as vcf_file:
